...
public class OrderService {
	...
	public int createOrder(OrderRequest orderRequest)
			throws FailedToCreateException, SQLException, InvalidException, DoesNotExistException {
	...
	public void updateOrder(int id, OrderRequest orderRequest)
			throws DoesNotExistException, SQLException, InvalidException {
		orderValidator.validateOrder(orderRequest);
